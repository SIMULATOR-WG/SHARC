...
class Parameters(object):
    ...
    def read_params(self):
        ...
        self.antenna_imt.bs_enable_beamsteering_vertical_limit  = config.get("IMT_ANTENNA", "bs_enable_beamsteering_vertical_limit")
        self.antenna_imt.bs_beamsteering_vertical_limit         = config.getfloat("IMT_ANTENNA", "bs_beamsteering_vertical_limit")
        #######################################################################
        # HOTSPOT
        #######################################################################
        ...
        self.eess_passive.distribution_enable     = config.get("EESS_PASSIVE", "distribution_enable")
        self.eess_passive.distribution_type       = config.get("EESS_PASSIVE", "distribution_type")
        self.eess_passive.nadir_angle_distribution    = config.get("EESS_PASSIVE", "nadir_angle_distribution")
