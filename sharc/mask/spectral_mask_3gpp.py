...
if __name__ == '__main__':
    ...
    #freq = 2680# 5 MHz guard band RAS
    freq = 2660 # 5 MHz guard band RAS
    band = 20
    #band = 20
    ...
    # rasx = np.linspace(2486, 2500, 60)
    # rasy = np.linspace(0, 0, 60)
    # rasx_ = np.linspace(2486, 2486, 60)
    # rasy_ = np.linspace(-13, 0, 60)
    # rasx_1 = np.linspace(2500, 2500, 60)
    # rasy_1 = np.linspace(0, -13, 60)

    # rasx = np.linspace(2700, 2700.5, 60)
    # rasy = np.linspace(0, 0, 60)
    # rasx_ = np.linspace(2700, 2700, 60)
    # rasy_ = np.linspace(-13, 0, 60)
    # rasx_1 = np.linspace(2700.5, 2700.5, 60)
    # rasy_1 = np.linspace(0, -13, 60)

    rasx = np.linspace(2656, 2670, 60)
    rasy = np.linspace(0, 0, 60)
    rasx_ = np.linspace(2656, 2656, 60)
    rasy_ = np.linspace(-13, 0, 60)
    rasx_1 = np.linspace(2670, 2670, 60)
    rasy_1 = np.linspace(0, -13, 60)

    plt.plot(rasx_1, rasy_1, 'r--', linewidth=2, color = 'orange', label= 'FS (PP) Band ')
    #plt.plot(rasx_1, rasy_1, 'r--', linewidth=2, color = 'orange', label= 'FS(PMP) ')
