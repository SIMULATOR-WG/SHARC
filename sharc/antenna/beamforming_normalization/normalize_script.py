...
# Order of parameters is: normalization, norm_file, element_pattern, 
...
co_channel_list = [False, False]
file_names = ['bs_norm.npz',
              'ue_norm.npz']

#%% Normalize and save using parameters hash
for par, c_chan, file in zip(param_list,co_channel_list,file_names):
    norm.generate_correction_matrix(par,c_chan,file)