...
if __name__ == '__main__':
    ...
    param1.bs_element_max_g = 8
    param1.bs_element_phi_3db = 65
    param1.bs_element_theta_3db = 65
    param1.bs_element_am = 30
    param1.bs_element_sla_v = 25
    param1.bs_n_rows = 4
    param1.bs_n_columns = 2
    ...
    f = plot1.plot_element_pattern(bs_array1, " Base Station", "ARRAY", "Beamforming d/λ = 0.5, Rec. ITU-R M.2101", 0)
    f1 = plot1.plot_element_pattern(bs_array, " Base Station", "ARRAY", "Beamforming d/λ = 0.5, Our Proposal", 1)
    # f.savefig(figs_dir + "BS_array.pdf", bbox_inches='tight')
