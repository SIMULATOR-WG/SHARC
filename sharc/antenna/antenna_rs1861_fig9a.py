...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  8 10:18:26 2017
...
class AntennaRS1861FIG9a(Antenna):
    """
    Implements the EESS sensor antenna for 23.6-24 GHz for Sensor type F1
    """
    ...
    def calculate_gain(self, *args, **kwargs) -> np.array:
        ...
        "Form parabolic equation according to figure 9, a*attˆ2+b*att+angle = 0"
        a = 0.00209524
        b = 0.14190476
        
        "From line eq for second part of fig 9.a att=m*angle+c"
        m = -3.637333
        c = -23.9904
...
if __name__ == '__main__':
    ...
    param27.antenna_pattern = "ITU-R RS.1861 Figure 9a"
    param27.frequency = 26000
    param27.antenna_gain = 50
    antenna27 = AntennaRS1861FIG9a(param27)
    ...
    plt.title("ITU-R RS.1861 Figure 9a antenna radiation pattern")
