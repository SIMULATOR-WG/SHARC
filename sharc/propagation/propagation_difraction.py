...
def Ld_difraction(d,f,a): # -*- coding: utf-8 -*-
    ...
    for i in range(0,2,1): 
        ...
        if i == 0:                        
           Ldftland = -Fx - func_Gt(K,Bdft,Yt) - func_Gr(K,Bdft,Yr)
        if i == 1:                        
           Ldftsea = -Fx - func_Gt(K,Bdft,Yt) - func_Gr(K,Bdft,Yr)
...
if __name__ == "__main__":
   ...
   #Ld50 and Ldbeta are equal, depending of a (0 == p and 1 == beta)
   Ld50 = Ld_difraction(d,f,a)
        
   a = 1
   Ldbeta = Ld_difraction(d,f,a)
