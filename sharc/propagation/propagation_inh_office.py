...
#    loss_los = inh.get_loss_los(distance_3D, frequency, shadowing)
#    loss_nlos = inh.get_loss_nlos(distance_3D, frequency, shadowing)
    loss_fs = PropagationFreeSpace().get_loss(distance_3D=distance_3D, frequency=frequency)
...
#    ax.semilogx(distance_2D, loss_nlos, label = "InH-office NLOS")
#    ax.semilogx(distance_2D, loss_los, label = "InH-office LOS")
