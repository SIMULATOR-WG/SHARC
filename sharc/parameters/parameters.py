...
class Parameters(object):
    ...
    def read_params(self):
        ...
        self.antenna_imt.bs_tx_multiplication_k     = config.getfloat("IMT_ANTENNA", "bs_tx_multiplication_k")
        ...
        self.antenna_imt.bs_rx_multiplication_k   = config.getfloat("IMT_ANTENNA", "bs_rx_multiplication_k")
        ...
        self.antenna_imt.ue_tx_multiplication_k = config.getfloat("IMT_ANTENNA", "ue_tx_multiplication_k")
        ...
        self.antenna_imt.ue_rx_multiplication_k  = config.getfloat("IMT_ANTENNA", "ue_rx_multiplication_k")
