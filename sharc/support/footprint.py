...
if __name__ == '__main__':
    ...
    # Create object
    fprint90 = Footprint(0.4,elevation_deg=90)
    fprint45 = Footprint(0.4,elevation_deg=45)
    #fprint30 = Footprint(0.325,elevation_deg=30)
    fprint20 = Footprint(0.4,elevation_deg=20)
    ...
    fprint = Footprint(0.4,elevation_deg=20)
