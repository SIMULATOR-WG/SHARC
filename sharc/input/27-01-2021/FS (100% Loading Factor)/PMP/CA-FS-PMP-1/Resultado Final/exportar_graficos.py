...
data3= pd.read_csv('[SYS] CDF of system INR_120000.txt',skiprows=1, sep='	',header=None)
data4= pd.read_csv('[SYS] CDF of system INR_250000.txt',skiprows=1, sep='	',header=None)
