    ...
    def generate_eess_passive_sensor(param: ParametersEessPassive):
        ...
        if (param.distribution_enable == "ON"):
            if (param.distribution_type == "UNIFORM"):
                if (type(param.nadir_angle_distribution)) != list:
                    aux_nadir_angle = param.nadir_angle_distribution.split(',')
        ...
        if param.antenna_pattern == "OMNI":
            ...
            eess_passive_sensor.antenna = np.array([AntennaRS2043(param)])
        else:
