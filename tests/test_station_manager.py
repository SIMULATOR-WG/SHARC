...
class StationManagerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.station_manager.tx_antenna = np.array([AntennaBeamformingImt(par,60,-10), AntennaBeamformingImt(par,180,-10), AntennaBeamformingImt(par,300,-10)])
        par = self.param.get_antenna_parameters("BS","RX")
        self.station_manager.rx_antenna = np.array([AntennaBeamformingImt(par,90,-15), AntennaBeamformingImt(par,210,-15), AntennaBeamformingImt(par,330,-15)])
        ...
        par = self.param.get_antenna_parameters("BS","TX")
        self.station_manager2.tx_antenna = np.array([AntennaBeamformingImt(par,0,-5), AntennaBeamformingImt(par,180,-5)])
        par = self.param.get_antenna_parameters("BS","RX")
        self.station_manager2.rx_antenna = np.array([AntennaBeamformingImt(par,0,-5), AntennaBeamformingImt(par,180,-5)])
        ...
        self.station_manager3.tx_antenna = np.array([AntennaBeamformingImt(par,0,-30), AntennaBeamformingImt(par,35,45)])
        par = self.param.get_antenna_parameters("UE","RX")
        self.station_manager3.rx_antenna = np.array([AntennaBeamformingImt(par,100,-15), AntennaBeamformingImt(par,180,60)])
        ...
        par = self.param.get_antenna_parameters("UE","TX")
        self.station.tx_antenna = AntennaBeamformingImt(par,100,-10)
        par = self.param.get_antenna_parameters("UE","RX")
        self.station.rx_antenna = AntennaBeamformingImt(par,100,-10)
        ...
        par = self.param.get_antenna_parameters("BS","TX")
        self.station2.tx_antenna = AntennaBeamformingImt(par,90,-15)
        par = self.param.get_antenna_parameters("BS","RX")
        self.station2.rx_antenna = AntennaBeamformingImt(par,-90,-15)
    ...
    def test_tx_antenna(self):
        self.assertEqual(self.station_manager.tx_antenna[0].azimuth, 60)
        self.assertEqual(self.station_manager.tx_antenna[0].elevation, -10)
        self.assertEqual(self.station_manager.tx_antenna[0].n_rows, 16)
        self.assertEqual(self.station_manager.tx_antenna[0].n_cols, 16)
        self.assertEqual(self.station_manager.tx_antenna[0].dh, 1)
        self.assertEqual(self.station_manager.tx_antenna[0].dv, 1)
        self.assertEqual(self.station_manager.tx_antenna[0].element.g_max, 5)
        self.assertEqual(self.station_manager.tx_antenna[0].element.phi_3db, 80)
        self.assertEqual(self.station_manager.tx_antenna[0].element.theta_3db, 60)
        self.assertEqual(self.station_manager.tx_antenna[0].element.am, 30)
        self.assertEqual(self.station_manager.tx_antenna[0].element.sla_v, 30)
        
        self.assertEqual(self.station_manager.tx_antenna[1].azimuth, 180)
        self.assertEqual(self.station_manager.tx_antenna[1].elevation, -10)
        self.assertEqual(self.station_manager.tx_antenna[1].n_rows, 16)
        self.assertEqual(self.station_manager.tx_antenna[1].n_cols, 16)
        self.assertEqual(self.station_manager.tx_antenna[1].dh, 1)
        self.assertEqual(self.station_manager.tx_antenna[1].dv, 1)
        self.assertEqual(self.station_manager.tx_antenna[1].element.g_max, 5)
        self.assertEqual(self.station_manager.tx_antenna[1].element.phi_3db, 80)
        self.assertEqual(self.station_manager.tx_antenna[1].element.theta_3db, 60)
        self.assertEqual(self.station_manager.tx_antenna[1].element.am, 30)
        self.assertEqual(self.station_manager.tx_antenna[1].element.sla_v, 30)
        
        self.assertEqual(self.station_manager.tx_antenna[2].azimuth, 300)
        self.assertEqual(self.station_manager.tx_antenna[2].elevation, -10)
        self.assertEqual(self.station_manager.tx_antenna[2].n_rows, 16)
        self.assertEqual(self.station_manager.tx_antenna[2].n_cols, 16)
        self.assertEqual(self.station_manager.tx_antenna[2].dh, 1)
        self.assertEqual(self.station_manager.tx_antenna[2].dv, 1)
        self.assertEqual(self.station_manager.tx_antenna[2].element.g_max, 5)
        self.assertEqual(self.station_manager.tx_antenna[2].element.phi_3db, 80)
        self.assertEqual(self.station_manager.tx_antenna[2].element.theta_3db, 60)
        self.assertEqual(self.station_manager.tx_antenna[2].element.am, 30)
        self.assertEqual(self.station_manager.tx_antenna[2].element.sla_v, 30)
        
        par = self.param.get_antenna_parameters("BS","TX")
        self.station_manager.tx_antenna[[0,2]] = np.array([AntennaBeamformingImt(par,0,-5), AntennaBeamformingImt(par,180,-5)])
        
        self.assertEqual(self.station_manager.tx_antenna[0].azimuth, 0)
        self.assertEqual(self.station_manager.tx_antenna[0].elevation, -5)
        self.assertEqual(self.station_manager.tx_antenna[0].n_rows, 16)
        self.assertEqual(self.station_manager.tx_antenna[0].n_cols, 16)
        self.assertEqual(self.station_manager.tx_antenna[0].dh, 1)
        self.assertEqual(self.station_manager.tx_antenna[0].dv, 1)
        ...
        self.assertEqual(self.station_manager.tx_antenna[2].azimuth, 180)
        self.assertEqual(self.station_manager.tx_antenna[2].elevation, -5)
        self.assertEqual(self.station_manager.tx_antenna[2].n_rows, 16)
        self.assertEqual(self.station_manager.tx_antenna[2].n_cols, 16)
        self.assertEqual(self.station_manager.tx_antenna[2].dh, 1)
        self.assertEqual(self.station_manager.tx_antenna[2].dv, 1)
    ...
    def test_rx_antenna(self):
        self.assertEqual(self.station_manager.rx_antenna[0].azimuth, 90)
        self.assertEqual(self.station_manager.rx_antenna[0].elevation, -15)
        self.assertEqual(self.station_manager.rx_antenna[0].n_rows, 8)
        self.assertEqual(self.station_manager.rx_antenna[0].n_cols, 8)
        self.assertEqual(self.station_manager.rx_antenna[0].dh, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[0].dv, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[0].element.g_max, 10)
        self.assertEqual(self.station_manager.rx_antenna[0].element.phi_3db, 65)
        self.assertEqual(self.station_manager.rx_antenna[0].element.theta_3db, 75)
        self.assertEqual(self.station_manager.rx_antenna[0].element.am, 35)
        self.assertEqual(self.station_manager.rx_antenna[0].element.sla_v, 25)
        
        self.assertEqual(self.station_manager.rx_antenna[1].azimuth, 210)
        self.assertEqual(self.station_manager.rx_antenna[1].elevation, -15)
        self.assertEqual(self.station_manager.rx_antenna[1].n_rows, 8)
        self.assertEqual(self.station_manager.rx_antenna[1].n_cols, 8)
        self.assertEqual(self.station_manager.rx_antenna[1].dh, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[1].dv, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[1].element.g_max, 10)
        self.assertEqual(self.station_manager.rx_antenna[1].element.phi_3db, 65)
        self.assertEqual(self.station_manager.rx_antenna[1].element.theta_3db, 75)
        self.assertEqual(self.station_manager.rx_antenna[1].element.am, 35)
        self.assertEqual(self.station_manager.rx_antenna[1].element.sla_v, 25)
        
        self.assertEqual(self.station_manager.rx_antenna[2].azimuth, 330)
        self.assertEqual(self.station_manager.rx_antenna[2].elevation, -15)
        self.assertEqual(self.station_manager.rx_antenna[2].n_rows, 8)
        self.assertEqual(self.station_manager.rx_antenna[2].n_cols, 8)
        self.assertEqual(self.station_manager.rx_antenna[2].dh, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[2].dv, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[2].element.g_max, 10)
        self.assertEqual(self.station_manager.rx_antenna[2].element.phi_3db, 65)
        self.assertEqual(self.station_manager.rx_antenna[2].element.theta_3db, 75)
        self.assertEqual(self.station_manager.rx_antenna[2].element.am, 35)
        self.assertEqual(self.station_manager.rx_antenna[2].element.sla_v, 25)
        
        par = self.param.get_antenna_parameters("BS","RX")
        self.station_manager.rx_antenna[[0,2]] = np.array([AntennaBeamformingImt(par,0,-5), AntennaBeamformingImt(par,180,-5)])
        
        self.assertEqual(self.station_manager.rx_antenna[0].azimuth, 0)
        self.assertEqual(self.station_manager.rx_antenna[0].elevation, -5)
        self.assertEqual(self.station_manager.rx_antenna[0].n_rows, 8)
        self.assertEqual(self.station_manager.rx_antenna[0].n_cols, 8)
        self.assertEqual(self.station_manager.rx_antenna[0].dh, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[0].dv, 0.5)
        ...
        self.assertEqual(self.station_manager.rx_antenna[2].azimuth, 180)
        self.assertEqual(self.station_manager.rx_antenna[2].elevation, -5)
        self.assertEqual(self.station_manager.rx_antenna[2].n_rows, 8)
        self.assertEqual(self.station_manager.rx_antenna[2].n_cols, 8)
        self.assertEqual(self.station_manager.rx_antenna[2].dh, 0.5)
        self.assertEqual(self.station_manager.rx_antenna[2].dv, 0.5)
