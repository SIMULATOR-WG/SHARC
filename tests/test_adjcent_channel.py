...
class SimulationAdjacentTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.param.general.simulation_type = "ADJACENT"
    ...
    def test_simulation_2bs_4ue_downlink(self):
        ...
        rx_interf_bs1 = 10*math.log10(interf_pow) - 10 -3 \
                          - coupling_loss_imt_system[0]
        rx_interf_bs2 = 10*math.log10(interf_pow) - 10 -3 \
                          - coupling_loss_imt_system[2]
    ...
    def test_simulation_2bs_4ue_uplink(self):
        ...
        interference = 10*math.log10(interf_pow) - 10 - 3 - 4 \
                          - coupling_loss_imt_system
