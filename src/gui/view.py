...
class View(tkinter.Tk, Observer):
    ...
    def initialize(self):
        ...
        self.__scrolledtext.grid(column=0, row=1, columnspan=6, sticky='EW')
        ...
        self.__clear_button.grid(column=3, row=0, sticky='EW')          
        ...
        self.__copy_button.grid(column=4, row=0, sticky='EW')        
